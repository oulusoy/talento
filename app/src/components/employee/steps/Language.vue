<template>
  <div class="main-grid p-3">
    <b-jumbotron class="max1000 aliceblue" >
      ...
      <b-row class="m-4">
        <b-col>
          <div>
            ...
            <b-form-input id="english" v-model="language.english" type="range" min="0" max="10" step="1"></b-form-input>
            <p>{{ english }}</p>
          </div>
        </b-col>
        <b-col>
          <div>
            ...
            <b-form-input id="german" v-model="language.german" type="range" min="0" max="10" step="1"></b-form-input>
            <p>{{ german }}</p>
          </div>
        </b-col>
      </b-row>
      <b-row class="m-4">
        <b-col>
          <b-form-group id="input-group-3" label="Welche Sprache sprichst du noch ?" label-for="input-3">
            <b-form-select
                id="input-3"
